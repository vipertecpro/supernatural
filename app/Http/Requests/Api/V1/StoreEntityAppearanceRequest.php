...
class StoreEntityAppearanceRequest extends FormRequest
{
    /**
    ...
    {
        return $this->user()?->can('create', EntityAppearance::class) === true;
    }
