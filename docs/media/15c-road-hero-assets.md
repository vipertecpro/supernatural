...
The hero uses original procedural geometry, shaders, CSS, and Web Audio plus three rights-cleared CC0 asphalt maps. This avoids ambiguous vehicle, character, symbol, HDRI, and audio licences while giving the road a real photographed surface response. Every scene input is registered in `resources/js/features/experience/road-hero/asset-manifest.ts`.
...
| Asphalt 01 diffuse, OpenGL normal, and roughness maps | Rob Tuytel / Poly Haven | https://polyhaven.com/a/asphalt_01 | CC0 1.0 | Yes | Yes | No | Yes | Three 1K JPEG files; 2,321,536 bytes total | Adds real surface breakup and wet-road light response while remaining fully redistributable |
| Atmospheric omen ring | Bankai / this repository | Local source code | Project source terms; original work | Yes for this project | Yes | No external attribution | Yes | Generated Three.js emissive geometry | Uses the supplied promotional image only as broad mood/composition reference; copies no logo, title, or official symbol |
| Creature encounters | Bankai / this repository | Local source code | Project source terms; original work | Yes for this project | Yes | No external attribution | Yes | Generated Three.js geometry/materials | Original ghost, demon, vampire, and wraith forms that can dissolve on collision without downloaded character art |
| Spectral runner VFX cutout | OpenAI image generation for this repository | Local generated source and alpha PNG | Original generated project asset | Yes for this project | Yes | No external attribution | Yes | 512×768 optimized runtime PNG with alpha; 1024×1536 alpha master and paired chroma source retained | Original human apparition generated without franchise characters or symbols, layered over time-driven Three.js motion for a more realistic forest-to-road charge |
...
| Poly Haven models and HDRIs | https://polyhaven.com/ | Rejected as unnecessary. Its CC0 Asphalt 01 texture maps were accepted above, while the road geometry, sky, fog, and forest remain procedural for lower transfer cost and controllable light/dark interpolation. |
